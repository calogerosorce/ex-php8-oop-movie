...
<head>
    ...
    <style>
        * {
        ...
        .jumb {
            background-image: url('https://www.meganerd.it/wp-content/uploads/2021/01/Star-Wars-ere-scaled.jpg');
...
<body>
    ...
    <main class="mb-4">
        <div class="jumb">
            <h1 class="text-center text-white p-5">Contatti</h1>
        </div>

        <div class="container">
            <div class="card">
                <div class="card-img-top text-center p-3">
                    <img src="../img/dff4c5d5-360c-4893-abb4-b13899c3f506.png" alt="Contatti">
                </div>
                <div class="contatti align-items-center p-3">
                    <h1>Come Contattarci</h1>
                    <p><strong>Per qualsiasi informazione o richiesta, puoi contattarci tramite i seguenti canali:</strong></p>
                    <ul>
                        <li>Email: info@ghostfilms.com</li>
